  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-6 space-y-6 animate-fade-in-up">
      ...
      {invoice.status === 'awaiting_approval' && (
        <div className="rounded-xl border border-blue-200/70 bg-white shadow-lg shadow-blue-100/20 overflow-hidden">
            ...
            {!showReject ? (
              <div className="space-y-6">
                <div className="space-y-1">
                  <p className="text-sm font-semibold text-slate-700">Signature options</p>
                  <p className="text-xs text-slate-400">Provide at least one signature method below</p>
                </div>

                <div className="bg-white border border-blue-100/80 rounded-xl overflow-hidden">
                  <div className="px-4 py-3 border-b border-blue-50 bg-gradient-to-r from-blue-50/50 to-indigo-50/30 flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold text-blue-700 uppercase tracking-wider">Type your name</span>
                    <span className="text-[10px] font-medium text-slate-400 ml-auto">(optional)</span>
                  </div>
                  <div className="p-4">
                    <div className="relative">
                      <input
                ...
                <div className="bg-white border border-blue-100/80 rounded-xl overflow-hidden">
                  <div className="px-4 py-3 border-b border-blue-50 bg-gradient-to-r from-blue-50/50 to-indigo-50/30 flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold text-blue-700 uppercase tracking-wider">Draw your signature</span>
                    <span className="text-[10px] font-medium text-slate-400 ml-auto">(optional)</span>
                  </div>
                  <div className="p-4">
                    <SignatureCanvas
                ...
                <div className="bg-gradient-to-r from-blue-50/60 to-indigo-50/40 rounded-xl border border-blue-100/60 p-4">
                ...
                <div className="flex flex-wrap gap-3 pt-1">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-lg border border-slate-200
                               ...
                               disabled:opacity-40 active:scale-[0.97] shadow-sm hover:shadow-md hover:shadow-red-100/50"
                  >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Line Items */}
          <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
            <div className="px-6 py-4 border-b border-slate-100 bg-gradient-to-r from-indigo-50/60 via-blue-50/30 to-white">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gradient-to-r from-indigo-50/50 to-blue-50/30 border-b border-slate-100">
                    <th className="px-6 py-3.5 text-left text-xs font-semibold text-indigo-700 uppercase tracking-wider">Description</th>
                    <th className="px-6 py-3.5 text-right text-xs font-semibold text-indigo-700 uppercase tracking-wider">Qty</th>
                    <th className="px-6 py-3.5 text-right text-xs font-semibold text-indigo-700 uppercase tracking-wider">Unit Price</th>
                    <th className="px-6 py-3.5 text-right text-xs font-semibold text-indigo-700 uppercase tracking-wider">VAT</th>
                    <th className="px-6 py-3.5 text-right text-xs font-semibold text-indigo-700 uppercase tracking-wider">Total</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100/60">
                  {invoice.items.map((item, idx) => (
                    <tr key={item.id}
                        className={`transition-all duration-200 hover:bg-gradient-to-r hover:from-indigo-50/60 hover:to-blue-50/40 ${idx % 2 === 0 ? 'bg-white' : 'bg-slate-50/20'}`}
            ...
            {/* Totals */}
            <div className="border-t border-slate-100 px-6 py-4 space-y-2.5 bg-gradient-to-b from-indigo-50/30 via-white to-white">
